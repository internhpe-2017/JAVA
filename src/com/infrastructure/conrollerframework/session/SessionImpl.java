...
/**
 * The SystemSessionImpl is the actual implementation used in to represent a
 * {@link SystemSession} It holds all informations about a session between a
 * client and server. The SystemSessionImpl is never passed to the client and
 * only used internaly
 */
public class SessionImpl extends VO implements UserSession {
	...
	public SessionImpl(String userName) throws InfrastructureException {
		if (userName != null) {
			_userName = userName;
		} else {
	 ...
	 */
	public SessionImpl(String userName, String system, String userType, String loginId, Locale locale)
	 ...
	 * 
	 * @return CpnyName value Updated the condition for TAW by Ramesh on
	 ...
	 * @param manager
	 */
	public void setmanager(String manager) throws InfrastructureException, BusinessException {
		UserVO user = null;
	}
	 ...
	 * @param asstMgr
	 */
	public void setasstMgr(String asstMgr) throws InfrastructureException, BusinessException {
		UserVO user = null;
	 ...
	 * @param genMgr
	 */
	public void setgenMgr(String genMgr) throws InfrastructureException, BusinessException {
		UserVO user = null;
	}
